...
function rpress_get_payment_custome( $payment_id){
...
function rpress_get_payments_order_custome($args = array()){
        $payments = new RPRESS_Payments_Query( $args );
        
	return $payments->get_payments_by_order();
}
/**
 ...
 */
function rpress_get_payment_meta_user_info( $payment_id , $custome = false ) {
	$payment = new RPRESS_Payment( $payment_id ,false,$custome );
