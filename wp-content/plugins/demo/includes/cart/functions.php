 ...
 */
function rpress_get_cart_item_price( $fooditem_id = 0, $options = array(), $price_id , $remove_tax_from_inclusive = false ) {
  return RPRESS()->cart->get_item_price( $fooditem_id, $options, $price_id, $remove_tax_from_inclusive );
}
