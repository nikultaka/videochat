...
function get_cart_discounts_html( $discount_details = false ) {
	...
	$html = '';
		...
		$rate        = rpress_format_discount_rate( $discout_type, $discount_details->amount );    
                
                $discounts = rpress_set_cart_discount( $discount_details->voucher_name );
                $total       = rpress_get_cart_total( $discounts );
                $discount_value = get_discount_value( $discount_details, $total );
                $remove_url  = add_query_arg(
			array(
				'rpress_action'    => 'remove_cart_discount',
				'discount_id'   => $discount_details->voucher_id,
				'discount_code' => $discount_details->voucher_name
			),
			rpress_get_checkout_uri()
		);
        ...
        $discount_html = '';
        $discount_html .= "<span class=\"rpress_discount\">";
        $discount_html .= "<span class=\"rpress_discount_label\">$coupon_text:&nbsp;$discount_details->voucher_name</span>";
        $discount_html .= "<span class=\"rpress_discount_rate_wrap\">";
        $discount_html .= "<span class=\"rpress_discount_rate\">$discount_value</span>\n";
        $discount_html .= "<a href=\"$remove_url\" data-code=\"$discount_details->voucher_name\" class=\"rpress_discount_remove\"></a>\n";
        $discount_html .= "</span>";
        $discount_html .= "</span>\n";

		$html .= apply_filters( 'rpress_get_cart_discount_html', $discount_html, $discount_details->voucher_name, $rate, $remove_url );
