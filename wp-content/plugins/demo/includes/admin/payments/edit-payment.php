...
?>
<div class="wrap">
	<h2><?php _e( 'Edit Payment', 'restropress' ); ?>: <?php echo get_the_title( $payment_id ) . ' - #' . $payment_id; ?> - <a href="<?php echo admin_url( 'admin.php?page=rpress-payment-history' ); ?>" class="button-secondary"><?php _e( 'Go Back', 'restropress' ); ?></a></h2>
	<form id="rpress-edit-payment" action="" method="post">
		<table class="form-table">
			<tbody>
				...
				<tr>
					<th scope="row" valign="top">
						<span><?php _e( 'Order Notes', 'restropress' ); ?></span>
					</th>
					<td>
						<?php
