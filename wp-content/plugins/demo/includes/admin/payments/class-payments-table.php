	...
	public function service_type_filters() { ?>
    	...
    	<div class="rpress-service-type-filters-wrap">
      		<ul class="subsubsub">
	        	...
	        	<li>
	          		<a href="<?php echo admin_url('/admin.php?page=rpress-payment-history'); ?>">
	          	...
	          	foreach( $get_service_types as $service_key => $service_label ) : ?>
	          		<li>
	          			<a href="<?php echo admin_url('/admin.php?page=rpress-payment-history&service_type='.$service_key); ?>">
	...
	public function column_default( $payment, $column_name ) {
        ...
        $value   = date_i18n( get_option( 'date_format' ), $date );
	      ...
	      $current_order_status = rpress_get_order_status( $payment->ID );
		    $options = '<select disabled="" data-payment-id="'.$payment->ID.'" data-current-status="'.$current_order_status.'" name="rp_order_status" class="rp_order_status rp_current_status_'.$current_order_status.'">';
