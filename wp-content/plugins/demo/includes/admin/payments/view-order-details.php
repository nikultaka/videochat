...
<div class="wrap rpress-wrap">
			...
			<div class="rpress-admin-box">
				...
				<div class="rpress-admin-box-inside">
					...
					<p>
						...
						<select name="rpress_order_status" class="medium-text" disabled="">
				...
				<div class="rpress-admin-box-inside">
					...
					<p>
						...
						<select name="rpress-payment-status" class="medium-text rpress-payment-status" disabled="">
	...
	<div class="food-item-list">
            <table class="table  table-dark">
                ...
                <tbody>
            <?php 
            $addon_items = $cart_item['addon_items'];
            
            foreach ($addon_items as $key=>$value){
                if(is_array($value)){ ?>
                    <tr>
                        <td><?php echo $value['addon_item_name'] ?></td>
                        <td><?php echo $value['cat_name'] ?></td>
                        <td><?php echo rpress_currency_filter( rpress_format_amount( $value['price'] )); ?></td>
                    </tr>
        ...
        <div class="postbox rpress-edit-purchase-element rp-add-update-elements <?php echo $column_count; ?>" style="display:none;">
