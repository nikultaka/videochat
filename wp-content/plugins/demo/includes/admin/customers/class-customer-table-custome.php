...
class RPRESS_Customer_Reports_Table extends WP_List_Table {
	...
	public function column_name( $item ) {
		...
		$view_url    = admin_url( 'admin.php?page=rpress-customers-custome&view=overview&id=' . $item['id'] );
		$actions     = array(
			'view'   => '<a href="' . $view_url . '">' . __( 'View', 'restropress' ) . '</a>',
			'delete' => '<a href="' . admin_url( 'admin.php?page=rpress-customers-custome&view=delete&id=' . $item['id'] ) . '">' . __( 'Delete', 'restropress' ) . '</a>'
		);
	...
	public function reports_data() {
		...
		$this->args = $args;
		$customers  = get_client_info_for_customer_custome($args); 
                //RPRESS()->customers->get_customers( $args );
