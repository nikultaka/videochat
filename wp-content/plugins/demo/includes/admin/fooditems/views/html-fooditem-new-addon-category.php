    ...
    <div class="rp-metabox-content-wrapper">
      <div class="rp-col-6 addon-category">
        <table class="form-table">
          ...
          <tbody>
            <td>
              <input type="text" name="addon_category[<?php echo $row; ?>][name]" id="" class="rp-input addon-category-name" placeholder="<?php esc_html_e( 'Addon Category Name', 'restropress' ); ?>">
            </td>
            <td>
              <select name="addon_category[<?php echo $row; ?>][type]" class="rp-input addon-category-type ttt">
                <?php
