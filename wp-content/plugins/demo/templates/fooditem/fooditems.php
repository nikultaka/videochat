...
//$data = get_product_list_by_category();

?>

<div class="rpress-section rp-col-lg-12 rp-col-md-12 rp-col-sm-12 rp-col-xs-12 page-main-list">
  ...
  if ( $shortcode_atts['category'] || $shortcode_atts['category_menu'] ) {
    ...
    if ( is_array( $all_terms ) && !empty( $all_terms ) ) :
      ...
      endforeach;
	    ...
	    ?>
            <?php do_action( 'rpress_fooditems_list_after_custome' ); ?>
	</div>
