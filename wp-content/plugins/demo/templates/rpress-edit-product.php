...
<div class="view-food-item-wrap">
	...
	<div class="rp-col-md-12 md-12-top special-inst <?php echo $color; ?>">
		...
		<textarea placeholder="<?php _e( 'e.g. allergies, extra spicy, etc.', 'restropress' ); ?>" class="rp-col-md-12 special-instructions" name="special_instruction">{cartinstructions}</textarea>
	</div>
	<?php endif; ?>
</div>
