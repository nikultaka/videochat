...
<div class="modal micromodal-slide" id="rpressModalCustome" aria-hidden="true">
      ...
      <footer class="modal__footer modal-footer">
        <div class="rpress-popup-actions edit-rpress-popup-actions rp-col-md-12">
          ...
          <div class="rp-col-md-8 rp-col-xs-8">
            <a href="javascript:void(0);" data-item-qty="1" data-cart-key="" data-item-id="" data-variable-id="" data-item-price="" data-cart-action="" class="center submit-fooditem-button text-center inline rp-col-md-6 <?php echo $color; ?>">
