...
new WPUpdatesThemeUpdater_2785( 'http://wp-updates.com/api/2/theme', basename(get_template_directory()) );
*/

if( !class_exists('WPUpdatesThemeUpdater_2785') ) {
    class WPUpdatesThemeUpdater_2785 {
    	...
    	function check_for_update( $transient ) {
    		...
    		if ($this->license_code) $request_args['license'] = $this->license_code;
